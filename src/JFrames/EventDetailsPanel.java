...
public class EventDetailsPanel extends javax.swing.JPanel {
    ...
    private String convertToSqlDate(String input) throws Exception {
        ...
        LocalDate date = LocalDate.parse(input, userFormat);
        return date.format(sqlFormat);
    }
    ...
    private void StartEventBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_StartEventBtnActionPerformed
        ...
        String eventDateInput = EventDateTF.getText().trim();

        if (eventName.isEmpty() || eventDateInput.isEmpty()) {
        ...
        try {
            sqlDate = convertToSqlDate(eventDateInput);
        } catch (Exception e) {
        ...
        Event event = new Event(userId, eventName, sqlDate);
